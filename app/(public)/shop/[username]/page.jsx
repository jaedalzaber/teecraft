...
export default function StoreShop() {
  ...
  const fetchStoreData = async () => {
    try {
      ...
      console.log(data)
      setStoreInfo(data.store); // Set the general store information
      setProducts(data.store.products); // Set the products associated with the store
    } catch (error) {
      // 3. Handle errors by displaying a toast message
